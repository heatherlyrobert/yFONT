...
tCHARS   s_chars   [MAX_CHARS] = {
    ...
    *> {  150, 0x03a8, "PSI"        , "---s------"},                                  <* 
    *> {  151, 0x03a9, "OMEGA"      , "---s------"},                                  <*/
   /*-my---uni-----name-------(typical latin)------------------*/
   {  161,    161, "iexclaim"   , "--cs------"},
   {  162,    191, "iquestion"  , "--cs------"},
   {  163,    216, "null"       , "--cs------"},
