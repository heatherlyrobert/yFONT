...
uchar       s_text1      [LEN_STR]   = "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ´ π ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü.  ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ";
/*---(sizes)-----------------------------*/
