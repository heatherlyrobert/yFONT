...
main               (int argc, char *argv[])
{
   ...
   /*> if (strcmp ("code"   , s_glist) == 0)  strlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ´ π  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);                                                        <* 
    *> if (strcmp ("serious", s_glist) == 0)  strlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ´ π ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñó.  ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);   <*/
   if (strcmp ("code"   , s_glist) == 0)  strlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ∑ ¢ °  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);
   if (strcmp ("serious", s_glist) == 0)  strlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ∑ ¢ °  ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);
   font_load          ();
   color_pairs        ('0');
   draw_init          ();
   draw_main          ();
