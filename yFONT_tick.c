...
static uchar       s_text1      [LEN_STR]   = "the quick brown fox jumped over the lazy dog.  ∑ £ § • ¶ ß ® © ™ ´   ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ";
/*---(sizes)-----------------------------*/
...
main               (int argc, char *argv[])
{
   ...
   if (strcmp ("norm"   , s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ?.;,!*:\"\'/@#$%^&()_<>{}[]+-=\\|`~.  ", LEN_STR);
   if (strcmp ("tsae"   , s_glist) == 0)  ystrlcpy (s_text, "siyowina qaze nihi gaya geyv zuda siyv gohv wenv saqu goya sida tanu wagv kuwa guqe nasu zuqa naqu disv  ", LEN_STR);
   if (strcmp ("mand"   , s_glist) == 0)  ystrlcpy (s_text, "siyo'wina.  DGKNQTcdghklmnpqstwxyzaefiouvrj0123456789!@#$%^&,:\"\'()-.  ", LEN_STR);
   if (strcmp ("test"   , s_glist) == 0)  ystrlcpy (s_text, "abcd   a   b   c   d   e   f   g   h   i   j   k   l   m   n   o   p   q   r   s   t   u   v   w   x   y   z   ", LEN_STR);
   /*> if (strcmp ("code"   , s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ´ π  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);                                                        <* 
    *> if (strcmp ("serious", s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ´ π ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñó.  ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);   <*/
   if (strcmp ("code"   , s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ∑ ¢ °  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);
   if (strcmp ("serious", s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ∑ ¢ °  ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);
   font_load          ();
   color_pairs        ('0');
   draw_init          ();
   draw_main          ();
   ...
   while (rc == 0) {
      ...
      if (strcmp ("norm"   , s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ?.;,!*:\"\'/@#$%^&()_<>{}[]+-=\\|`~.  ", LEN_STR);
      if (strcmp ("tsae"   , s_glist) == 0)  ystrlcpy (s_text, "siyo wina qaze nihi gaya geyv zuda siyv gohv wenv saqu goya sida tanu wagv kuwa guqe nasu zuqa naqu disv  ", LEN_STR);
      if (strcmp ("mand"   , s_glist) == 0)  ystrlcpy (s_text, "siyo'wina.  DGKNQTcdghklmnpqstwxyzaefiouvrj0123456789!@#$%^&,:\"\'()-.  ", LEN_STR);
      if (strcmp ("test"   , s_glist) == 0)  ystrlcpy (s_text, "   a   b   c   d   e   f   g   h   i   j   k   l   m   n   o   p   q   r   s   t   u   v   w   x   y   z   ", LEN_STR);
      if (strcmp ("code"   , s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ∑ ¢ °  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);
      if (strcmp ("serious", s_glist) == 0)  ystrlcpy (s_text, "the quick brown fox jumped over the lazy dog.  £ § • ¶ ß ® © ™ ∑ ¢ °  ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ.  THE QUICK BROWN FOX JUMPED OVER THE LAZY DOG.  abcdefghijklmnopqrstuvwxyz.  ABCDEFGHIJKLMNOPQRSTUVWXYZ.  ", LEN_STR);
